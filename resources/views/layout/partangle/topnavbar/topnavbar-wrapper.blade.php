<header class="topnavbar-wrapper">
    ...
    <nav class="navbar topnavbar">
        ...
        <div class="navbar-header"><a class="navbar-brand" href="#/">
                <div class="brand-logo"><img class="img-fluid" src="{{ asset('angle/img/logo.png') }}" alt="App Logo"></div>
                <div class="brand-logo-collapsed"><img class="img-fluid" src="{{ asset('angle/img/logo-single.png') }}" alt="App Logo"></div>
